...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0c10] text-zinc-300 font-mono">
      ...
      <section className="relative min-h-screen flex flex-col justify-center overflow-hidden pt-14">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-24">
          ...
          <p className="text-zinc-400 text-lg md:text-xl max-w-2xl leading-relaxed mb-12">
            Our tools and services use Next-Generation IoT (Internet of Things)
            technology and devices to enable property managers, businesses, and
            homeowners to contribute to the sustainable use of the World&apos;s
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              onClick={() => setDepinOpen(true)}
              className="px-6 py-3 border border-zinc-600 hover:border-teal-700 text-zinc-300 hover:text-teal-300 text-sm tracking-widest uppercase transition-colors"
            >
              SECURE DePIN →
            </button>
          </div>

          <div className="mt-20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl">
            {[
              {
                challenge: "WATER",
              ...
              },
              {
                ...
                mission: "Decentralized networks for the real world.",
                company: "SECURE DePIN",
                color: "text-teal-400",
                dot: "bg-teal-400",
                border: "hover:border-teal-900",
              },
            ].map((item) => (
              <div
                key={item.challenge}
                className={`border border-zinc-800 ${item.border} transition-colors p-5`}
              >
                <div className="flex items-center gap-2 mb-4">
                  <span
                    className={`inline-block w-1.5 h-1.5 rounded-full ${item.dot}`}
                  />
                  <span
                    className={`text-xs tracking-[0.15em] uppercase ${item.color}`}
                  >
                    {item.company}
                  </span>
                </div>
          ...
          <div className="mb-12 border border-zinc-800 hover:border-zinc-600 transition-colors">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-10 border-b md:border-b-0 md:border-r border-zinc-800">
                ...
                <div className="text-xs text-blue-400 tracking-widest mb-6">
                  secureblue.earth
                </div>
                <p className="text-zinc-400 leading-relaxed mb-8">
                  An end-to-end autonomous water management ecosystem. SECURE
                  Blue delivers next-generation IoT infrastructure combining
                  live sensor telemetry, smart irrigation controls, leak
                  detection, automated shut-off valves, and atmospheric water
                  generation to reduce waste, protect assets, and improve water
                  resilience.
                </p>
              ...
              <div className="p-10 bg-zinc-900/30">
                <div className="text-xs tracking-widest text-zinc-600 mb-6 uppercase">
                  System Snapshot
                </div>
          ...
          <div className="mb-12 border border-zinc-800 hover:border-zinc-600 transition-colors">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-10 border-b md:border-b-0 md:border-r border-zinc-800">
                ...
                <div className="text-xs text-purple-400 tracking-widest mb-6">
                  metawork.tools
                </div>
                <p className="text-zinc-400 leading-relaxed mb-8">
                  A Web3 creator platform where artists, designers, and
                  entrepreneurs upload their intellectual property, design
                  custom products, and earn royalties through on-chain
                  ownership. MetaWork connects creators to print-on-demand
                  fulfillment and e-commerce — turning original IP into a
                  scalable passive income stream.
                </p>
                <div className="grid grid-cols-2 gap-3 mb-8">
                  {[
              ...
              <div className="p-10 bg-zinc-900/30">
                ...
                <div className="space-y-3 font-mono text-xs">
                  {[
                    ...
                    {
                      key: "PRODUCT_TYPES",
                      val: "Merch, IP, Authenticated Docs",
                      color: "text-zinc-400",
                    },
                    {
                      key: "ROYALTY_MODEL",
                      val: "Per-Use IP Licensing",
                      color: "text-purple-400",
                    },
                  ].map(({ key, val, color }) => (
                    <div
          ...
          <div className="mb-12 border border-zinc-800 hover:border-zinc-600 transition-colors">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-10 border-b md:border-b-0 md:border-r border-zinc-800">
                ...
                <div className="text-xs text-amber-400 tracking-widest mb-6">
                  securecargo.tools
                </div>
                <p className="text-zinc-400 leading-relaxed mb-8">
                  Inventors of the SuperRatchet and the AnyMount Cargo Control
                  System. SECURE Cargo Control innovates next-generation tools
                  to help workers in the world&apos;s most dangerous industries
                  perform their jobs more efficiently and safely — whether
                  hauling a weekend toy or suspending an I-beam 20 stories off
                  the ground.
                </p>
                <div className="grid grid-cols-2 gap-3 mb-8">
                  {[
              ...
              <div className="p-10 bg-zinc-900/30">
                ...
                <div className="space-y-3 font-mono text-xs">
                  {[
                    {
                      key: "FLAGSHIP",
                      val: "SuperRatchet System",
                      color: "text-zinc-300",
                    },
                    {
                      key: "PLATFORM",
                      val: "AnyMount CC System",
                      color: "text-zinc-300",
                    },
                    {
                      key: "INDUSTRIES",
                      val: "Construction, Transport",
                      color: "text-zinc-400",
                    },
                    {
                      key: "COMPLIANCE",
          ...
          <div className="border border-zinc-800 hover:border-zinc-600 transition-colors">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="p-10 border-b md:border-b-0 md:border-r border-zinc-800">
                ...
                <div className="text-xs text-teal-400 tracking-widest mb-6">
                  securedepin.io
                </div>
                <p className="text-zinc-400 leading-relaxed mb-8">
                  SECURE DePIN is focused on operating real decentralized physical
                  infrastructure. We host Algorand nodes, stake and support Akash
                  network infrastructure, and deploy and manage Helium-connected
                  wireless and sensor networks — building dependable systems in the
                  field, not financial games on a screen.
                </p>
                <div className="grid grid-cols-2 gap-3 mb-8">
                  {[
                    "Algorand node hosting & operations",
                    "Akash infrastructure participation",
                    "Helium network deployment & management",
                    "LoRaWAN gateway coordination",
                    "Distributed compute & uptime monitoring",
                    "Real-world sensor and connectivity systems",
                  ].map((feat) => (
                    <div key={feat} className="flex items-start gap-2">
                ...
                <button
                  onClick={() => setDepinOpen(true)}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-teal-700 hover:bg-teal-600 text-white text-xs tracking-widest uppercase transition-colors"
                >
                  LEARN MORE →
                </button>
              </div>
              <div className="p-10 bg-zinc-900/30">
                ...
                <div className="space-y-3 font-mono text-xs">
                  {[
                    { key: "SYS_STATUS",   val: "BUILDING",                    color: "text-teal-400"  },
                    { key: "ALGORAND",     val: "Node Hosting",                color: "text-zinc-300"  },
                    { key: "AKASH",        val: "Infrastructure Support",      color: "text-zinc-300"  },
                    { key: "HELIUM",       val: "Network Operations",          color: "text-teal-400"  },
                    { key: "FIELD_LAYER",  val: "Wireless + Sensor Systems",   color: "text-green-400" },
                    { key: "FOCUS",        val: "Physical Infra, Uptime, Ops", color: "text-zinc-400"  },
                  ].map(({ key, val, color }) => (
                    <div
                      key={key}
                      className="flex justify-between items-center border-b border-zinc-800/60 pb-2"
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border border-zinc-800 hover:border-zinc-600 transition-colors p-10">
              ...
              <div className="text-xs text-blue-400 tracking-widest mb-6">
                CO-FOUNDER // SECURE TOOL CO.
              </div>
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                Visionary entrepreneur and company builder. Adam-Paul
                co-founded SECURE Tool Company with a talent for identifying the
                right people, technologies, and strategies to tackle the
                world&apos;s most pressing challenges — assembling the teams and
                partnerships that turn bold ideas into operating businesses.
              </p>
            ...
            <div className="border border-zinc-800 hover:border-zinc-600 transition-colors p-10">
              ...
              <div className="text-xs text-cyan-400 tracking-widest mb-6">
                CO-FOUNDER // SECURE TOOL CO.
              </div>
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                Inventor and technical founder. Scott built the AnyMount Cargo
                Control System, assembled the IoT infrastructure stack behind
                SECURE Blue, and pioneers the use of LoRaWAN networks for water
                management. He has a rare talent for turning real-world problems
                into scalable product lines.
              </p>
              <div className="space-y-2 font-mono text-xs">
                {[
                  { k: "ROLE", v: "COO" },
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            ...
            <div className="text-zinc-600 text-xs">
              Solving the world&apos;s greatest challenges through
              next-generation IoT tools and services.
            </div>
          ...
          <div className="flex flex-col gap-3 text-xs">
            <div className="flex flex-wrap gap-6 text-zinc-500">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-blue-400 transition-colors tracking-widest uppercase"
              >
                SECURE Blue
              </a>
              <a
              ...
              <button
                onClick={() => setCargoOpen(true)}
                className="hover:text-amber-400 transition-colors tracking-widest uppercase"
              >
                SECURE Cargo
              </button>
              <button
              ...
              <a
                href="mailto:office@securetool.company"
                className="hover:text-zinc-300 transition-colors tracking-widest uppercase"
              >
                Contact
              </a>
            </div>
        ...
        >
          ...
          >
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-8">
              The SECURE Cargo Control site is under construction. Check back
              soon for the full SuperRatchet and AnyMount product lineup.
            </p>
      ...
      {/* ── SECURE DePIN PLACEHOLDER MODAL ── */}
      {depinOpen && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center p-6"
        ...
        >
          <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" />
          <div
            className="relative z-10 border border-teal-800/60 bg-[#0a0c10] p-10 max-w-md w-full"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              onClick={() => setDepinOpen(false)}
            ...
            <p className="text-zinc-400 text-sm leading-relaxed mb-8">
              SECURE DePIN is under development as an infrastructure-first platform
              focused on operating real decentralized systems — including Algorand
              nodes, Akash participation, and Helium-connected wireless networks for
              real-world connectivity and field deployment.
            </p>
            <div className="space-y-2 font-mono text-xs mb-8">
              {[
                { key: "STATUS",  val: "BUILDING",                    color: "text-teal-400"  },
                { key: "MODEL",   val: "Infrastructure-First",        color: "text-zinc-300"  },
                { key: "FOCUS",   val: "Nodes, Networks, Deployment", color: "text-zinc-300"  },
            ...
            <div className="flex gap-3">
              <a
                href="mailto:office@securetool.company"
                className="px-5 py-2.5 bg-teal-700 hover:bg-teal-600 text-white text-xs tracking-widest uppercase transition-colors"
              >
                GET IN TOUCH →
              </a>
              <button
